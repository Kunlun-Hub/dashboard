  ...
  ["px-4 py-3.5 rounded-md border text-sm font-normal flex gap-3 font-light"],
  {
    variants: {
      variant: {
        ...
        warning:
          "bg-netbird-50 border-netbird-200 text-netbird-800 dark:bg-netbird-500/10 dark:border-netbird-400/20 dark:text-netbird-150",
        info: "bg-netbird-50 border-netbird-200 text-netbird-800 dark:bg-netbird-400/10 dark:border-netbird-400/20 dark:text-netbird-100",
        success:
