    ...
    >
      ...
      <div
        className={cn(
          ...
          "bg-neutral-100 text-neutral-500 border-white group-hover:bg-neutral-200 step-circle",
          "[.stepper-bg-variant]:border-neutral-50 dark:[.stepper-bg-variant]:border-nb-gray-940",
        )}
      >
        {step}
      </div>
