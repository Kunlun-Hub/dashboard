  ...
  return (
    <Tabs.List
      className={cn(
        ...
        "lg:h-full items-start bg-white border-b-0 border-neutral-200 dark:bg-nb-gray dark:border-nb-gray-930",
  ...
  return (
    <TabsTrigger
      ...
      className={cn(
        ...
        value == currentValue
          ? "bg-neutral-100 text-neutral-900 dark:bg-nb-gray-920 dark:text-nb-gray-100"
          : disabled
          ? ""
          : "text-neutral-500 hover:bg-neutral-100 hover:text-neutral-900 dark:text-nb-gray-500 dark:hover:bg-nb-gray-900/50 dark:hover:text-nb-gray-200",
      )}
      value={value}
      onClick={() => {
