...
export const buttonVariants = cva(
  [
    ...
    "disabled:opacity-70 disabled:cursor-not-allowed disabled:dark:text-nb-gray-300 dark:ring-offset-nb-gray-950/50",
  ],
  {
    variants: {
      variant: {
        default: [
          "bg-white hover:text-neutral-950 focus:ring-netbird-400/30 hover:bg-neutral-100 border-gray-200 text-gray-900",
          "dark:focus:ring-netbird-500/40 dark:bg-nb-gray dark:text-nb-gray-400 dark:border-nb-gray-700/30 dark:hover:text-nb-gray-100 dark:hover:bg-nb-gray-800/50",
        ],
        primary: [
          "dark:focus:ring-netbird-600/50 dark:ring-offset-nb-gray-950/50 enabled:dark:bg-netbird disabled:dark:bg-nb-gray-910 dark:text-nb-gray-100 enabled:dark:hover:text-white enabled:dark:hover:bg-netbird-500/80",
        ...
        secondary: [
          ...
          "dark:ring-offset-nb-gray-950/50 dark:focus:ring-netbird-500/40",
          "dark:bg-nb-gray-920 dark:text-nb-gray-400 dark:border-nb-gray-700/40 dark:hover:text-nb-gray-100 dark:hover:bg-nb-gray-910",
        ],
        secondaryLighter: [
          "bg-white hover:text-neutral-950 focus:ring-netbird-400/30 hover:bg-neutral-100 border-gray-200 text-gray-900",
          "dark:ring-offset-nb-gray-950/50 dark:focus:ring-netbird-500/40",
          "dark:bg-nb-gray-900/70 dark:text-nb-gray-400 dark:border-nb-gray-700/70 dark:hover:text-nb-gray-100 dark:hover:bg-nb-gray-800/60",
        ],
        input: [
          "bg-white hover:text-neutral-950 focus:ring-netbird-400/30 hover:bg-neutral-100 border-neutral-200 text-gray-900",
          "dark:ring-offset-nb-gray-950/50 dark:focus:ring-netbird-500/40",
          "dark:bg-nb-gray-900  dark:text-nb-gray-400  dark:border-nb-gray-700 dark:hover:bg-nb-gray-900/80",
        ],
        dropdown: [
          "bg-white hover:text-neutral-950 focus:ring-netbird-400/30 hover:bg-neutral-100 border-neutral-200 text-gray-900",
          "dark:ring-offset-nb-gray-950/50 dark:focus:ring-netbird-500/40",
          "dark:bg-nb-gray-900/40 dark:text-nb-gray-400 dark:border-nb-gray-900 dark:hover:bg-nb-gray-900/50",
        ],
        dotted: [
          "bg-white hover:text-neutral-950 focus:ring-netbird-400/30 hover:bg-neutral-100 border-gray-200 text-gray-900 border-dashed",
          "dark:ring-offset-nb-gray-950/50 dark:focus:ring-netbird-500/40",
          "dark:bg-nb-gray-900/30 dark:text-nb-gray-400 dark:border-nb-gray-500/40 dark:hover:text-nb-gray-100 dark:hover:bg-nb-gray-900/50",
        ],
        tertiary: [
          ...
          "dark:focus:ring-netbird-500/40 dark:bg-white dark:text-gray-800 dark:border-nb-gray-700/40 dark:hover:bg-neutral-200 disabled:dark:bg-nb-gray-920 disabled:dark:text-nb-gray-300",
        ],
        white: [
        ...
        outline: [
          "bg-white hover:text-neutral-950 focus:ring-netbird-400/30 hover:bg-neutral-100 border-gray-200 text-gray-900",
          "dark:focus:ring-netbird-500/40 dark:bg-transparent dark:text-netbird dark:border-netbird dark:hover:bg-nb-gray-900/30",
        ],
        "danger-outline": [
        ...
        "danger-text": [
          "bg-transparent text-red-600 hover:text-red-700 border-transparent !px-0 !shadow-none !py-0 focus:ring-red-500/30 dark:bg-transparent dark:text-red-500 dark:hover:text-red-600 dark:border-transparent dark:ring-offset-nb-gray-950/50 rounded-sm",
        ],
        "default-outline": [
