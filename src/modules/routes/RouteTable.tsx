...
export const createRouteTableColumns = (
  ...
  },
  {
    ...
    header: ({ column }) => {
      return (
        <DataTableHeader column={column}>{t("nameservers.distributionGroups")}</DataTableHeader>
      );
    },
  ...
  },
  {
    ...
    header: ({ column }) => {
      return (
        <DataTableHeader column={column}>{t("accessPolicies.accessControlGroups")}</DataTableHeader>
      );
    },
