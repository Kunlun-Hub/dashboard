...
export const PostureCheckChecksCell = ({
  ...
  return (
    <div className={"flex"} onClick={onClick}>
      <div
        className={cn(
          "flex items-center gap-3 bg-white border border-neutral-200 py-1 rounded-full px-1 transition-all dark:bg-nb-gray-900/80 dark:border-nb-gray-800/50",
          !disableHover && "hover:bg-neutral-50 dark:hover:bg-nb-gray-800",
          className,
        )}
      >
