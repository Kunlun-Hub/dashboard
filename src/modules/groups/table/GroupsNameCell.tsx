...
export default function GroupsNameCell({ active, group }: Readonly<Props>) {
  ...
  return (
    <div className={""}>
      <div
        className={
          "inline-flex items-center justify-start text-neutral-700 dark:text-neutral-300 gap-2.5 py-2 px-3 pr-4 hover:bg-neutral-100 dark:hover:bg-nb-gray-800/60 cursor-pointer rounded-md"
        }
