...
export default function ServiceUserNameCell({ user }: Readonly<Props>) {
  return (
    <div className={cn("flex gap-4 px-2 py-1 items-center")}>
      <div
        className={
          "w-8 h-8 rounded-full relative flex items-center justify-center text-neutral-700 uppercase text-md font-medium bg-neutral-100 dark:text-white dark:bg-nb-gray-900"
        }
      >
