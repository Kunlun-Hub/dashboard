...
import { HuntressIntegration } from "@/interfaces/EDR";
import useGroupHelper from "@/modules/groups/useGroupHelper";
import {
  HUNTRESS_DOCUMENTATION_URL,
  HUNTRESS_NETBIRD_DOCUMENTATION_URL,
...
export default function HuntressConfiguration({
  open,
  onOpenChange,
  onSuccess,
  config,
...
export function ConfigurationContent({
  ...
  const [apiSecret, setApiSecret] = useState(secretPlaceholder);
    ...
    notify({
      ...
      promise: integrationRequest
        .put({
          ...
          api_secret: secretPlaceholder === apiSecret ? undefined : apiSecret,
