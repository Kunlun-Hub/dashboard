...
export function SetupContent({ onSuccess }: ModalProps) {
  ...
  const connect = async () => {
    notify({
      ...
      description: `Google Workspace was successfully connected to Cloink.`,
  ...
  return (
    ...
    >
      ...
      <IntegrationModalHeader
        ...
        title={"Connect Cloink with Google Workspace"}
        description={
      ...
      {step == 1 && (
        <div className={"px-8 py-3 flex flex-col gap-0 mt-4"}>
          <p className={"font-medium flex gap-3 items-center text-base"}>
            <Folder size={20} />
            Create Cloink project
          </p>
          <Steps>
            <Steps.Step step={1}>
              <p>
                Create a new <Mark copy>Cloink</Mark> project in the{" "}
                <InlineLink
                  className={"inline"}
                  target={"_blank"}
      ...
      {step == 3 && (
        <div className={"px-8 py-3 flex flex-col gap-0 mt-4"}>
          ...
          <Steps>
            ...
            <Steps.Step step={1}>
              <p className={"font-normal"}>
                Click <Mark>Cloink</Mark> to edit the service account. Copy the
          ...
          <div className={"mb-4"}>
            <Input
              ...
              placeholder={"cloink@loadtests-347817.iam.gserviceaccount.com"}
