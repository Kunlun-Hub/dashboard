...
export const messages = {
  en: {
    ...
    "relays.controlSearchPlaceholder": "Search groups or devices...",
    "relays.noControlSearchResults": "No matching targets.",
    "relays.relaySearchPlaceholder": "Search relays...",
    "relays.noRelaySearchResults": "No matching relays.",
    "relays.controlDefault": "Default order",
    "relays.noPreferredRelay": "Using global relay order",
    "relays.selectedRelayCount": "{count} preferred",
    "relays.editPreference": "Edit",
    "relays.clearPreference": "Clear",
    "relays.editPreferenceFor": "Edit relays for {name}",
    "relays.editPreferenceHelp":
      "Selected relays are placed first; unselected relays remain available as fallback.",
  ...
  "zh-CN": {
    ...
    "relays.controlSearchPlaceholder": "搜索设备组或设备...",
    "relays.noControlSearchResults": "没有匹配的配置对象。",
    "relays.relaySearchPlaceholder": "搜索中继...",
    "relays.noRelaySearchResults": "没有匹配的中继。",
    "relays.controlDefault": "默认顺序",
    "relays.noPreferredRelay": "使用全局中继顺序",
    "relays.selectedRelayCount": "已选 {count} 个首选",
    "relays.editPreference": "编辑",
    "relays.clearPreference": "清空",
    "relays.editPreferenceFor": "编辑 {name} 的中继",
    "relays.editPreferenceHelp":
      "选中的中继会排在前面，未选中的中继仍会作为备用候选。",
    "overview.title": "总览",
